...
export const Contactsmsnc_acceptscontact = {
  0: 'No',
  1: 'Yes'
} as const;
export type Contactsmsnc_acceptscontact = keyof typeof Contactsmsnc_acceptscontact;
...
export interface ContactsBase {
  ...
  msnc_acceptscontact: Contactsmsnc_acceptscontact;
...
export interface Contacts extends ContactsBase {
  ...
  msnc_acceptscontactname?: string;
